package edu.fsadriann.app.linkedlist.node.doubly;
...
public class LinkedNode<E> extends AbstractNode<E> {
    ...
    public String toString() {
        // Solo muestra el elemento y si tiene next/previous
        // NO llama a next.toString() o previous.toString() para evitar recursión infinita
        return "LinkedNode( Element: " + get().toString() + 
